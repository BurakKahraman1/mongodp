...
export default function Index({mData,pageNo,posts}) {
                    ...
                    <div className="w-full flex flex-col lg:mr-5 justify-between">
                        ...
                        {posts.pageInfo.offsetPagination.total>=PER_PAGE_FIRST &&
                            <div className="mt-10 mx-auto mb-10 lg:mb-0">
                                <Pagination type="blog" currentPageNo={pageNo} postCount={posts.pageInfo.offsetPagination.total}/>
                            </div>
                        }
                    </div>
                    <BlogRightBarMenu/>
...
export async function getServerSideProps(context) {
    ...
    const { data } = await client.query({
        query: AllPosts,
        variables: { size:PER_PAGE_FIRST,offset:pageNo*PER_PAGE_REST},
    });
