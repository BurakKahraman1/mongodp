                    ...
                    <div className="w-full flex flex-col lg:mr-5 justify-between">
                        ...
                        {posts.pageInfo.offsetPagination.total>=PER_PAGE_FIRST &&
                            <div className="mt-10 mx-auto mb-10 lg:mb-0">
                                <Pagination type="category" slug={slug} currentPageNo="1" postCount={posts.pageInfo.offsetPagination.total}/>
                            </div>
                        }
                    </div>
                    <BlogRightBarMenu/>
...
export async function getServerSideProps(context) {
    const { data } = await client.query({
        ...
        variables: { size:PER_PAGE_FIRST,offset:0,slug:context.params.slug},
    });
